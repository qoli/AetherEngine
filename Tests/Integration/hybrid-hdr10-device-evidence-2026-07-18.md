...
every unverified Dolby Vision profile remained typed unsupported. Later independent LG C3 rows admit
HLG and Dolby Vision Profile 8.4, making current admission
`[.sdr, .hdr10, .hlg, .dolbyVision]` with Dolby Vision restricted to `[.profile84]`; this HDR10 record
itself does not admit any other format.
